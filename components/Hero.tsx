  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(".line__inner", { yPercent: 105 }, { yPercent: 0, duration: 1, ease: "power4.out", stagger: 0.12 })
        ...
        .fromTo(".hero__aside, .hero__ctas, .hero__slider, .stamp", { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.8, ease: "power3.out", stagger: 0.1 }, "-=0.6");
    }, root);
    return () => ctx.revert();
  }, []);
      ...
      <div className="hero__inner">
        <div className="hero__content">
          ...
          <p className="hero__aside">
            Creăm site-uri, magazine online și landing page-uri optimizate SEO pentru Moldova
            — cu plăți, curierat și automatizări AI incluse.
          </p>

          <div className="hero__ctas">
            <a className="btn btn--solid" href="#contact">Cere o ofertă</a>
            <a className="btn" href="https://wa.me/37367550980" target="_blank" rel="noopener noreferrer">
