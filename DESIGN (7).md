...
### Switzer — Exclusive typeface for all UI. Weight 600 for display and large headings for bold, confident typographic presence; weight 500 for body, buttons, and small UI. The dramatic size range (11px meta text up to 137px display) with matching line-height compression (0.70 at 137px) turns the single family into both signage and paragraph text. Sourced from Fontshare (free, self-host). · `--font-switzer`
- **Font:** Switzer (via Fontshare)
- **Weights:** 500, 600
...
- **Role:** Exclusive typeface for all UI. Weight 600 for display and large headings for bold monumental presence; weight 500 for body, buttons, and small UI.
